    ...
    return (
        <main
            ...
            <div className={"relative"}>
                ...
                <span className={`lg:text-[20rem] text-[6rem] bg-gradient-to-br from-[#2f8d46] text-transparent bg-clip-text to-[#78BC61] animate-text via-[#73be73] ${lilitaOne.variable} font-sans`}>
                    GFG GLAU
                </span>
                </h1>
