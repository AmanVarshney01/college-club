    ...
    return (
        <main className={'w-screen h-screen relative flex justify-center items-center bg-[#131200]'}>
            ...
            <div className={"relative flex flex-col z-10"}>
                ...
                <span className={`drop-shadow-lg 2xl:text-[20rem] leading-none xl:text-[18rem] sm:text-[8rem] text-[5rem] lg:text-[15rem] md:text-[11rem] bg-gradient-to-br from-[#2f8d46] text-transparent bg-clip-text to-[#73be73] animate-text via-[#a6f1a6] ${lilitaOne.variable} font-sans`}>
                    GFG GLAU
                </span>
                </h1>
