    ...
    return (
        <section className={"w-full h-screen bg-transparent flex items-center"}>
            ...
            <div className={"w-full grid grid-flow-row items-center gap-12"}>
                <div className={""}>
                    <div id={"question-1"} className={"cursor-pointer shadow-black bg-[#181818] h-min py-8 px-5 shadow hover:text-[#D8E9A8] transition duration-400"}>
                        <h3 className={"text-5xl"}>How to join club?</h3>
                    </div>
                    <div id='answer-1' className={"answer bg-[#D3D3D3] text-black p-2 shadow text-semibold"}>
                ...
                <div className={""}>
                    <div id={"question-2"} className={"cursor-pointer shadow-black bg-[#181818] h-min py-8 px-5 shadow hover:text-[#D8E9A8] transition duration-400"}>
                        <h3 className={"text-5xl"}>How to join club?</h3>
                    </div>
                    <div id='answer-2' className={"answer bg-[#D3D3D3] text-black p-2 shadow text-semibold"}>
                        <p className={"text-xl"}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus amet aut consequuntur dolores ea eius enim esse illo in ipsa ipsam modi, nisi reiciendis, similique temporibus velit voluptatibus! Consequatur, consequuntur?</p>
                    </div>
                </div>
                <div className={""}>
                    <div id={"question-3"} className={"cursor-pointer shadow-black bg-[#181818] h-min py-8 px-5 shadow hover:text-[#D8E9A8] transition duration-400"}>
                        <h3 className={"text-5xl"}>How to join club?</h3>
                    </div>
                    <div id='answer-3' className={"answer bg-[#D3D3D3] text-black p-2 shadow text-semibold"}>
                        <p className={"text-xl"}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus amet aut consequuntur dolores ea eius enim esse illo in ipsa ipsam modi, nisi reiciendis, similique temporibus velit voluptatibus! Consequatur, consequuntur?</p>
                    </div>
                </div>
            </div>
