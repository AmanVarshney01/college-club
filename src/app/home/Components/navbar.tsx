...
export default function Navbar() {
    ...
    return (
        <div className={"fixed left-0 top-0 w-full h-min z-20 bg-[#121212] py-1 px-4 lg:py-2 lg:px-6"}>
            <div className={"flex flex-row justify-between items-center gap-16 w-full"}>
                <div className={" z-10 flex flex-row gap-5 items-center w-fit"}>
                    ...
                    <a href="/" className={""}><Image loading="lazy" id="linkCursor" width={250} className={""} src={glaGlauLogo} alt="gla glau "/></a>
                </div>
