...
export default function Bgicons() {
    return (
        <div
            className={"z-0 fixed top-0 right-0 opacity-10 left-0 bg-transparent h-screen max-w-full grid grid-cols-5 grid-rows-4 gap-10 place-items-center pointer-events-none"}>
