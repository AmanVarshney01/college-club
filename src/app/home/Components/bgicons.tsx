...
export default function Bgicons() {
    return (
        <div
            className={"fixed top-0 right-0 opacity-10 left-0 h-screen max-w-full grid grid-cols-5 grid-rows-5 gap-10 place-items-center pointer-events-none blur-[1px]"}>
