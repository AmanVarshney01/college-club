...
export default function Bgicons() {
    return (
        <div
            className={"absolute top-0 right-0 opacity-10 left-0 bg-transparent h-screen max-w-full grid grid-cols-5 grid-rows-5 gap-10 place-items-center pointer-events-none blur-[1px]"}>
            ...
            <Image className={"w-5 h-5"} width={5} height={5} src="/bg-icons/1.svg" alt=""/>
            <Image className={"w-5 h-5"} width={5} height={5} src="/bg-icons/6.svg" alt=""/>
            ...
            <Image className={"w-5 h-5"} width={5} height={5} src="/bg-icons/2.svg" alt=""/>
            <Image className={"w-5 h-5"} width={5} height={5} src="/bg-icons/2.svg" alt=""/>
            <Image className={"w-5 h-5"} width={5} height={5} src="/bg-icons/3.svg" alt=""/>
            <Image className={"w-5 h-5"} width={5} height={5} src="/bg-icons/4.svg" alt=""/>
            <Image className={"w-5 h-5"} width={5} height={5} src="/bg-icons/5.svg" alt=""/>
