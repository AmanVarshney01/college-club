...
export default function NavButton(props: ButtonProps) {
    ...
    return (
        ...
        // </button>
        <button id="linkCursor" onClick={scrollTo} className={" transition ease-in duration-200 2xl:text-2xl text-md hover:text-[#D8E9A8]"}><span className={""}>{name}</span></button>
    )
}